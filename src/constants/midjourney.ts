...
export const MIDJOURNEY_LOGO = 'https://i.postimg.cc/CKbQxmHg/photo-5992555847508233270-y-(1).jpg';
...
export const MIDJOURNEY_DEFAULT_TYPE = 'imagine';
export const MIDJOURNEY_DEFAULT_LOOP = false;
export const MIDJOURNEY_DEFAULT_RESOLUTION = '480p';
